#!/usr/bin/env python3
"""
Fix GraphSchemaContent (Location 1) in the schema:
1. Remove ALL patternProperties
2. Add explicit properties for all TI wrappers (concrete, abstract, exactlyOf, subtypesOf, properSubtypesOf)
...
def fix_graphschema_content():
    ...
    two_level_wrapper = {
        "oneOf": [
            {
                "type": "object",
                "description": "One-level TI wrapper (shorthand)",
                "properties": {
                    "graphType": graphtype_ref
                },
                "additionalProperties": False,
            ...
            {
                "type": "object",
                "description": "Two-level TI wrapper (explicit)",
                "properties": {
    ...
    new_graphschema_content = {
        ...
        "properties": {
            ...
            # Add explicit TI wrapper properties
            "concrete": one_level_wrapper,
            "abstract": one_level_wrapper,
            "sealed": one_level_wrapper,
            "final": one_level_wrapper,
    ...
    print("✓ Fixed GraphSchemaContent (Location 1)")
    print("  - Removed ALL patternProperties")
    print("  - Added explicit properties: concrete, abstract, sealed, final")
    print("  - Added explicit properties: exactlyOf, subtypesOf, properSubtypesOf")
