#!/usr/bin/env python3
"""
Validation script for LEX:2026.0.3.1 Catalog Example without IRI
Validates the example catalog without IRI against the LEX:2026.0.3.1 JSON Schema for LEX specifications
"""
...
from validate_catalog_example_0_3_1 import load_json_schema, load_yaml_schema, validate_schema, analyze_catalog_structure

def main():
    """Main validation function"""
    print("LEX:2026.0.3.1 Catalog Example (No IRI) Validation")
    print("=" * 60)
    ...
    yaml_schema_path = "src/grasch/examples/example-catalog-no-iri-lex-2026.0.3.1.yaml"
    ...
    print(f"\n🎉 Catalog LEX:2026.0.3.1 validation completed successfully!")
