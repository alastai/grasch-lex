#!/usr/bin/env python3
"""
Validation script for LEX:2026.0.3.1 Catalog Example
Validates the example catalog against the LEX:2026.0.3.1 JSON Schema for LEX specifications
"""
...
def main():
    ...
    print("LEX:2026.0.3.1 Catalog Example Validation")
    print("=" * 50)
    ...
    yaml_schema_path = "src/grasch/examples/example-catalog-lex-2026.0.3.1.yaml"
