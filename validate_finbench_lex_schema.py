#!/usr/bin/env python3
"""
Validate the FinBench LEX:2026.0.0 Graph Schema YAML against the JSON Schema
...
def main():
    ...
    yaml_path = "finbench-lex-2026.0.0-schema.yaml"
    ...
    try:
        ...
        if is_valid:
            ...
            print("The FinBench LEX:2026 Graph Schema YAML is valid according to the JSON Schema.")
